...
[online](https://gitflic.ru/project/magnolia1234/bypass-paywalls-firefox-clean)
...
* If none of these work, you can submit an issue on [GitHub](https://github.com/bpc-clone/bpc_firefox_support/issues).
...
### New site requests
You can [submit a request for a new website](https://github.com/bpc-clone/bpc_firefox_support/issues)  
...
* Download the latest release as xpi-file from [GitFlic](https://gitflic.ru/project/magnolia1234/bpc_uploads)
